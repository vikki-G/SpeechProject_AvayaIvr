 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2022-NOV-29  06:04:41 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2022-NOV-29  06:39:13 PM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("announce");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.DISPLAYMENU_FIELD_CONFIDENCE,
			IProjectVariables.DISPLAYMENU_FIELD_INPUTMODE,
			IProjectVariables.DISPLAYMENU_FIELD_INTERPRETATION,
			IProjectVariables.DISPLAYMENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.DISPLAYMENU_FIELD_NOMATCHCOUNT,
			IProjectVariables.DISPLAYMENU_FIELD_UTTERANCE,
			IProjectVariables.DISPLAYMENU_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.DISPLAYMENU, variableFields, null, session, false, false );
		session.putVariable(variable);
