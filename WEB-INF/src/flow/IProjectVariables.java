...
public interface IProjectVariables {
	...
	public static final String DISPLAYMENU_FIELD_CONFIDENCE = "confidence";
	public static final String DISPLAYMENU_FIELD_INPUTMODE = "inputmode";
	public static final String DISPLAYMENU_FIELD_INTERPRETATION = "interpretation";
	public static final String DISPLAYMENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String DISPLAYMENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String DISPLAYMENU_FIELD_UTTERANCE = "utterance";
	public static final String DISPLAYMENU_FIELD_VALUE = "value";
